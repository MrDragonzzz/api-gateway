package com.ljy.gateway.assist.domain.service;

import cn.hutool.http.HttpUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.TypeReference;
import com.ljy.gateway.assist.GatewayException;
import com.ljy.gateway.assist.common.Result;
...
public class GatewayCenterService {
    ...
    public void doRegister(String address,String groupId, String gatewayId, String gatewayName, String gatewayAddress){
        ...
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/config/registerGateway", paramMap, 3000);
        } catch (Exception e) {
    ...
    public Map<String,String> queryRedisConfig(String address){
        String resultStr;
        try{
            resultStr=HttpUtil.post(address+"/wg/admin/config/queryRedisConfig","",3000);
        }catch (Exception e){
