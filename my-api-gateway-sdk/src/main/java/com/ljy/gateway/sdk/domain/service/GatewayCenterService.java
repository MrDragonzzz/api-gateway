package com.ljy.gateway.sdk.domain.service;

import cn.hutool.core.lang.hash.Hash;
import cn.hutool.http.HttpUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.ljy.gateway.GatewayException;
import com.ljy.gateway.sdk.common.Result;
...
public class GatewayCenterService {
    ...
    public void doRegisterApplication(String address, String systemId, String systemName, String systemType, String systemRegistry) {
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplication", paramMap, 3000);
        } catch (Exception e) {
    ...
    public void doRegisterApplicationInterface(String address, String systemId, String interfaceId, String interfaceName, String interfaceVersion) {
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplicationInterface", paramMap, 3000);
        } catch (Exception e) {
    ...
    public void doRegisterApplicationInterfaceMethod(String address,
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplicationInterfaceMethod", paramMap, 3000);
        } catch (Exception e) {
    ...
    public void doRegisterEvent(String address,String systemId){
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerEvent", paramMap, 3000);
        } catch (Exception e) {
