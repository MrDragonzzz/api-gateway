package com.ljy.gateway.assist.config;

import com.ljy.gateway.assist.application.GatewayApplication;
...
public class GatewayAutoConfig {
    ...
    @Bean
    public GatewayApplication gatewayApplication(GatewayServiceProperties properties, GatewayCenterService registerGatewayService, com.ljy.gateway.core.session.Configuration configuration, Channel gatewaySocketServerChannel) {
     ...
     */
    @Bean
    public com.ljy.gateway.core.session.Configuration gatewayCore(GatewayServiceProperties properties){
        com.ljy.gateway.core.session.Configuration configuration = new com.ljy.gateway.core.session.Configuration();
    ...
    public Channel initGateway(com.ljy.gateway.core.session.Configuration configuration) throws ExecutionException, InterruptedException {
        // 1. 基于配置构建会话工厂
